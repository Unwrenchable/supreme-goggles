    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
          Choose from .fizz, .eth, .sol, and 15+ chains - or create your own .anything extension. Lifetime ownership, completely future-proof.
        </p>
        <DomainSearch />
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-16">
        <div className="bg-gradient-to-br from-purple-900/30 to-blue-900/30 border border-purple-500/30 rounded-xl p-8 hover:border-purple-500/60 transition">
          ...
          <h3 className="text-xl font-bold text-white mb-2">ANY Extension</h3>
